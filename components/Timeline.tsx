import { CircleDot, Gift, Heart, Music, Sparkles, type LucideIcon } from "lucide-react";
...
const SCHEDULE: TimelineEntry[] = [
  { time: "6:00 PM", title: "Party Begins", note: "Arrive, say hello, and find your doubles partner.", icon: Sparkles },
  ...
  return (
    <section id="party" aria-labelledby="party-title" className="relative px-4 py-20 sm:py-24">
      ...
      <ol className="relative mx-auto mt-16 max-w-4xl">
        ...
        />
        {SCHEDULE.map(({ time, title, note, icon: Icon }, i) => {
          const right = i % 2 === 1;
          return (
